        ...
        <div class="center background-black ">
            <div class="row row-cols-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-3 row-cols-xxl-3 row-cols-row-cols-sm-3 g-4">
                ...
                <div class="card h-100">
                    <Image src="/valeaoltului.webp" class="card-img-top" alt="First Event" width={400} height={300}/>
                    <div class="card-body">
                ...
                <div class="col">
                <div class="card h-100">
                    <Image src="/castelulcorvinilor.webp" class="card-img-top" alt="Second Event" width={400} height={300}/>
                    <div class="card-body">
                ...
                <div class="col">
                <div class="card h-100">
                    <Image src="/bog.webp" class="card-img-top" alt="Third Event" width={400} height={300}/>
                    <div class="card-body">
