...
export default function Home() {
  ...
  const submitHandler = (e) => {
    ...
    if (input) {
      ...
      //add js library confetti when submitHandler https://www.npmjs.com/package/js-confetti
    }
  };
  return (
    <div>
        ...
        <div className="container">
          <div className="row col-sm-12 col-lg-12 col-xxl-12">
            <div className="col-sm-4 col-lg-6 col-xxl-5">
              ...
              <p className="text-color-white montserrat effect">
                Sogno was created to give you a remarkable experience in
                different unique locations all over the world, where dreams are
                born and time is never planned.
              </p>
              <h3 className="text-color merienda">
                Subscribe to our next events
              </h3>
